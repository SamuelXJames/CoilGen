...
'''
The magnetic field need to cover at least the entire 
surface. The resolutio is dictation by num points and 
primarily a computation problem 

suggested values npoints = 10, n = 1

viewfield takes data as
[x1,y1,z1]
[x2,y2,z2]
